...
ias.extension(new IASTriggerExtension({text: 'Загрузить еще записи',offset: 1}));
ias.extension(new IASNoneLeftExtension({text: '<span class="no-more-post">Больше нет записей.</span>'}));
